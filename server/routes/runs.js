...
router.post('/', (req, res) => {
  try {
    const { repoId, workflowFile, event, branch, inputs, forceAll, jobId } = req.body;
    ...
    setImmediate(() => {
      runner.startRun(id, repo.path, workflowFile, runEvent, currentBranch, !!forceAll, jobId || null);
    });
